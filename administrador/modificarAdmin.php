...
require_once("../../controller/seleccionarAdmin.php");
    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content" id="panel_izq">
                ...
                <ul>
                    <li class="label">Usuario</li>
                    <li>
                        <a class="sidebar-sub-toggle">
                            <i class="ti-user"></i> Ander
                            <span class="badge badge-primary">2</span>
                            <span class="sidebar-collapse-icon ti-angle-down"></span>
                        </a>
                        <ul>
                            <li>
                                <a href="index.html"> <i class="ti-pencil-alt2"></i> Editar cuenta</a>
                            </li>
                            <li>
                                <a href="index.html"><i class=" ti-back-left "></i> Cerrar sesión</a>
                            </li>
