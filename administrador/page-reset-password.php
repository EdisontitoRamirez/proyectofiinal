                        ...
                        <div class="login-form">
                            ...
                            <form action="../../controller/generarClave.php" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="number" require name="identificacion" class="form-control" placeholder="Identificacion">
                                </div>
                                <div class="form-group">
                                    <label>Email:</label>
                                    <input type="email" requiere name="email" class="form-control" placeholder="Email">
                                </div>
                                <button type="submit" class="btn btn-primary btn-flat m-b-15">Enviar</button>
                                <div class="register-link text-center">
                                    <p>Back to <a href="login.php"> Volver al inicio de sesion</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
